...
$(document).ready(function(){
  ...
  $('.vertical-progress-bar ul li:nth-child(2)').css('height', Math.floor(about) + '%');
  $('.vertical-progress-bar ul li:nth-child(3)').css('height', Math.floor(domain) + '%');
  $('.vertical-progress-bar ul li:nth-child(4)').css('height', Math.floor(blogs) + '%');
  $('.vertical-progress-bar ul li:nth-child(5)').css('height', Math.floor(events) + '%');
  $('.vertical-progress-bar ul li:nth-child(6)').css('height', Math.floor(board) + '%');
  $('.vertical-progress-bar ul li:nth-child(7)').css('height', Math.floor(contact) + '%');
